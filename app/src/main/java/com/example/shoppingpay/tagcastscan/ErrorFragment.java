...
public class ErrorFragment extends DialogFragment {
    ...
    public static void showDialogFragment(FragmentManager fragmentManager, String tag, androidx.fragment.app.Fragment fragment) {
            ...
            case TYPE_RETRY:
                builder.setPositiveButton(getString(R.string.retry), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        MainTagCastActivity mainActivity = (MainTagCastActivity) activity;
